...
function ModalEdit() {
  ...
  return (
    <div
      className={contextPopup.activePopup ? "modal__view fixed  h-[100vh] bg-black/50 top-0 bottom-0 left-0 right-0 visible opacity-1 z-[1000] duration-[100ms] ease-in-out flex justify-center items-center": "modal__view fixed h-[100vh] bg-black/50 top-0 bottom-0 left-0 right-0 flex justify-center items-center invisible opacity-0 z-[-1] duration-[100ms] ease-in-out"}
      ...
      >
        <div className="modal-window__inner">
          ...
          <form className="modal-window__content">
            ...
            >
              <option value="analysis" className="modal-window__point py-[5px]">
                Анализ
              </option>
              <option value="accepted" className="modal-window__point py-[5px]">
                Принято
              </option>
              <option value="canceled" className="modal-window__point py-[5px]">
                Отклонен
              </option>
              <option
                value="postponed"
