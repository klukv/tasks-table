...
function FormTag() {
  ...
  return (
    <div className="filter-tags" ref={refTagMenu}>
      ...
      <form className={!activePopup ? 'filter-tags__form absolute invisible opacity-0 duration-[200ms] ease-in-out top-[46px] left-[-50px] min-w-[200px] bg-[#dde9fc] border-[1px] border-solid border-[#80B6FF] rounded-[10px]' : 'filter-tags__form absolute visible opacity-1 duration-[200ms] ease-in-out top-[46px] left-[-50px] min-w-[200px] bg-[#dde9fc] border-[1px] border-solid border-[#80B6FF] rounded-[10px]'}>
