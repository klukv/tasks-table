...
function Status() {
  ...
  return (
    <div className="filter-status" ref={refStatusMenu}>
      <button
      ...
      <form className={!activePopup ? 'filter-status__form absolute invisible opacity-0 duration-[200ms] ease-in-out top-[46px] left-[-50px] min-w-[200px] bg-[#dde9fc] border-[1px] border-solid border-[#80B6FF] rounded-[10px]' : 'filter-status__form absolute visible opacity-1 duration-[200ms] ease-in-out top-[46px] left-[-50px] min-w-[200px] bg-[#dde9fc] border-[1px] border-solid border-[#80B6FF] rounded-[10px]'}>
        <div className="filter-status__inner p-[10px]">
          <ul className="filter-status__list">
            <li className="filter-status__list-point flex items-center p-[5px] mb-[10px]">
              <input type="radio" className="filter-status__input" />
